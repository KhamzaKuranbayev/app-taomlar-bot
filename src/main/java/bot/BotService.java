...
public class BotService {
    ...
    private static InlineKeyboardMarkup getInlineKeyboards(List<Category> categoryList) {
        ...
        while (iterator.hasNext()) {
            ...
            button1.setCallbackData("category/" + next.getId().toString()); // category/6
            buttons.add(button1);
    ...
    public static SendPhoto showProductInfoById(Message message, long productId) {
        ...
        /**
         *  9TA INLINE BUTTON FOR COUNT OF ORDER
         */
    ...
    public static SendMessage addProductToCart(Message message, long productId, int count) {
        SendMessage sendMessage = new SendMessage();
        sendMessage.setParseMode(ParseMode.MARKDOWN);
        sendMessage.setChatId(message.getChatId().toString());
        sendMessage.setText("Maxsulot savatcha qo'shildi!");
        ...
        if (product == null || product.getId() == null) {
            sendMessage.setText("Product Not Found with ID {" + productId + "}");
            return sendMessage;
        }

        OrderCart orderCart = orderCartService.findByCartAndProduct(cart.getId(), productId);
        if (orderCart == null) {
